...
/* 316 */	NdrFcShort( 0x40a ),	/* Type Offset=1034 */
...
/* 352 */	NdrFcShort( 0x40e ),	/* Type Offset=1038 */
...
static const MIDL_SERVER_INFO ISupaMunkiElement_ServerInfo = 
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(16) _ISupaMunkiElementProxyVtbl = 
{
